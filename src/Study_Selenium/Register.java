...
public class Register {
	...
	private By firstNameElenment = By.id("firstname");
	private By lastNameElenment= By.id("lastname");
	private By emailElenment= By.id("email_address");
	private By passElenment= By.id("password");
	private By confPassElenment= By.id("confirmation");
